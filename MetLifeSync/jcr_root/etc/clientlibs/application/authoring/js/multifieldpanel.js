 ...
 * #L%
 *
 * ¡¡¡¡NOTES FROM XUMAK DEV: !!!!
 *
 * This codes overrides the multifieldpanel and it's the latest by Jan,2016
 * https://github.com/Adobe-Consulting-Services/acs-aem-commons/blob/01cd1d1fffd023c896e10ab0d93dbb4213668e15/content/src/main/content/jcr_root/apps/acs-commons/widgets/source/js/multipanel.js
 * This was added in order to fix some issues with multifieldpanel
 * which are not present in the current acs commnos versions (<1.9.6) and can not be upgraded due to our current
 * xcqb version
 *
 *
 */
