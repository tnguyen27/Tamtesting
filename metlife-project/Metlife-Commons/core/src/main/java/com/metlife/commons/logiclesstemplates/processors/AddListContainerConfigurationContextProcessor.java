...
public class AddListContainerConfigurationContextProcessor
    ...
    private static final String MEDIA_CONTACT_RESOURCE_TYPE =
            "metlifeCommons/components/section/pressroom-media-contact";

    /**
     * CONTACT_US_SECTION_HEADER_RESOURCE_TYPE.
     */
    private static final String CONTACT_US_SECTION_HEADER_CONTAINER_RESOURCE_TYPE =
            "metlifeCommons/components/section/contactus-section-header-container";
    ...
    public final Set<String> requiredResourceTypes() {
        return Sets.newHashSet(MEDIA_CONTACT_RESOURCE_TYPE,
                CONTACT_US_SECTION_HEADER_CONTAINER_RESOURCE_TYPE);
    }
    ...
    public final void process(
        ...
        final XCQBConfiguration configuration =
                configurationProvider.getFor(slingHttpServletRequest.getResource().getResourceType());
        ...
        for (final String propName : propsWithListArray) {
            ...
            if (templateContentModel.has(nameArray)) {
                ...
                int y = 0;
                if (categories != null) {
                    for (final HashMap<String, Object> category : categories) {
                        ...
                        category.put(nameList,
                                getItemList(item, nameList + Constants.DASH + y));
                        y++;
                    }
                }
            }
     ...
     */
    private ArrayList<String> getItemList(final int itemNumber, final String propName) {
