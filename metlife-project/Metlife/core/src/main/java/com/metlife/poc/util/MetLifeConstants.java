...
public final class MetLifeConstants {
    ...
    public static final String NEWS_ROOM_ARCHIVE_RESOURCE_TYPE =
            "metlifeCommons/components/section/press-room-archive";
    ...
    /**
     * Image Foundation  Resource type.
     */
    public static final String IMAGE_RESOURCE_TYPE = "foundation/components/image";
