...
/**
 * EvaluateAndConditionContextProcessor
 * This context processor obtains the list of properties stored in the
 * <b>xk_evaluateAndCondition</b> or
 * any property that contains <xk_evaluateAndCondition</b> and makes an AND
 ...
 *
 * WARNING. I you want to have more than one evaluation you should to have
 * the property
 * <b>xk_evaluateAndCondition</b>.
 *
 * -­‐-­‐-­‐-­‐-­‐-­‐-­‐-­‐-­‐-­‐-­‐-­‐-­‐-­‐-­‐-­‐-­‐-­‐-­‐-­‐-­‐-­‐-­‐-­‐-­‐-
 * Change History
 * ----------------------------------------------------------------------------
 * Version | Date       | Developer       | Changes
 * 1.0     | 29/01/2016 | Pablo Garcia    | Initial Creation
 * ----------------------------------------------------------------------------
 */
@Component
@Service
public class EvaluateAndConditionContextProcessor
    ...
    ContentModel contentModel)
        ...
        if (configObject.containsKey(MetLifeConstants.XK_EVALUATE_CONDITIONS)) {
            final Iterator<String> keys = configObject.keySet().iterator();
            while (keys.hasNext()) {
                final String key = keys.next();
                if (key.contains(MetLifeConstants.XK_EVALUATE_CONDITIONS)) {
                    final Collection<String> props = (Collection<String>)
                            configObject.get(key);
                    final Iterator<String> propsIterator = props.iterator();
                    boolean evaluation = Boolean.TRUE;
                    String propertyName = MetLifeConstants.AND;
